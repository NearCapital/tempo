...
impl<K, V> Mapping<K, V> {
    ...
    where
        ...
        V: StorableType,
    {
        V::handle(key.mapping_slot(self.base_slot), LayoutCtx::FULL, self.address)
    }
...
mod tests {
    ...
    fn test_mapping_size() {
        ...
        // Mapping contains: U256 (32) + Address (20 + 4 for 8-byte alignment) + PhantomData (0) =
        // 56 bytes
        ...
        assert_eq!(std::mem::size_of::<Mapping<Address, Mapping<Address, U256>>>(), 56);
    }
    ...
    fn test_mapping_basic_properties() {
        ...
        assert_eq!(derived_slot.slot(), expected_slot, ".at() should derive correct slot");
    }
    ...
    fn test_nested_mapping_basic_properties() {
        ...
        // Property 2: Double-hash - second .at() returns final Slot with correct double-derived
        // slot
