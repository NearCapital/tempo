...
pub enum TempoInvalidTransaction {
    ...
    ///
    /// Tempo transactions have variable intrinsic gas costs based on signature type and nonce
    /// usage. This error occurs when the gas_limit is less than the calculated intrinsic gas.
    #[error(
