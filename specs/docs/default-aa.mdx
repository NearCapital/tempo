...
:::warning
**Note: This feature will likely be deprecated before mainnet launch.** We recommend using the standard [Tempo Transaction](/protocol/specs/tempo-transactions) type instead if you need smart contract functionality.
:::
