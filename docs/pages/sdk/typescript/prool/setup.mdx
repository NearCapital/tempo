...
Setup a Tempo node instance programmatically in TypeScript using `prool` by following the steps below.

::::steps

## Install

To add a programmatic Tempo node instance to your project, install `prool`:
...
```ts
import { Instance, Server } from 'tempo.ts/prool'
